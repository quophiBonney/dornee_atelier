...
const GlobalStyle = () => (
  <style>{`
    ...
    :root{
      ...
      --panel-border-hi:rgba(0,229,255,0.35);
      --cyan:#00e5ff;
      --violet:#7c5cfc;
      --text-1:#e9eef9;
      --text-2:#8b95ac;
    ...
    .vtx-root{
      background:
        radial-gradient(ellipse 900px 500px at 15% -10%, rgba(124,92,252,0.16), transparent 60%),
        radial-gradient(ellipse 700px 500px at 100% 0%, rgba(0,229,255,0.10), transparent 55%),
        var(--bg);
      color:var(--text-1);
      font-family:'Inter', ui-sans-serif, system-ui, sans-serif;
    }
    .font-display{ font-family:'Space Grotesk', ui-sans-serif, system-ui, sans-serif; }
    .font-mono{ font-family:'JetBrains Mono', ui-monospace, SFMono-Regular, monospace; font-variant-numeric: tabular-nums; }
    ...
    .grid-bg{
      ...
      -webkit-mask-image: radial-gradient(ellipse 80% 60% at 20% 0%, black, transparent 75%);
      mask-image: radial-gradient(ellipse 80% 60% at 20% 0%, black, transparent 75%);
    }
    ...
    .glow-cyan{ box-shadow: 0 0 0 1px rgba(0,229,255,0.15), 0 0 24px -6px rgba(0,229,255,0.35); }
    .glow-violet{ box-shadow: 0 0 0 1px rgba(124,92,252,0.18), 0 0 24px -6px rgba(124,92,252,0.4); }

    .hover-lift{ transition: transform .25s ease, box-shadow .25s ease, border-color .25s ease; }
    .hover-lift:hover{ transform: translateY(-2px); border-color: var(--panel-border-hi); }
    ...
    .rail{ transition: transform .35s cubic-bezier(.16,1,.3,1); }
    ...
    .badge-success{ color:var(--success); background:rgba(46,230,166,0.10); border-color:rgba(46,230,166,0.25); }
    .badge-warning{ color:var(--warning); background:rgba(255,184,77,0.10); border-color:rgba(255,184,77,0.25); }
    .badge-danger{ color:var(--danger); background:rgba(255,92,122,0.10); border-color:rgba(255,92,122,0.25); }
    .badge-info{ color:var(--info); background:rgba(92,168,255,0.10); border-color:rgba(92,168,255,0.25); }
    .badge-neutral{ color:var(--text-2); background:rgba(255,255,255,0.06); border-color:var(--panel-border); }
    ...
    .vtx-input::placeholder{ color:var(--text-3); }
    .vtx-input:focus{ outline:none; border-color:rgba(0,229,255,0.5); box-shadow:0 0 0 3px rgba(0,229,255,0.10); }

    .row-hover{ transition: background-color .15s ease; }
    .row-hover:hover{ background:rgba(255,255,255,0.028); }

    .scrollbar-thin::-webkit-scrollbar{ height:6px; width:6px; }
    .scrollbar-thin::-webkit-scrollbar-thumb{ background:rgba(255,255,255,0.14); border-radius:99px; }
...
function TopBar({ page, onMenuClick, query, setQuery }) {
...
function MainContent({ page, query }) {
  switch (page) {
    case "users":
...
export default function Test() {
  ...
  return (
    <div className="vtx-root relative flex h-screen w-full overflow-hidden">
      <GlobalStyle />
      ...
      <main className="relative z-10 flex-1 overflow-y-auto">
        ...
        >
          ...
          <div className="mt-6" key={page}>
            <MainContent page={page} query={query} />
          </div>
        </div>
      </main>
    </div>
